...
def test_total_weight(accounts, rpc, gauge_controller, three_gauges):
...
def test_change_type_weight(accounts, rpc, gauge_controller, three_gauges):
...
def test_change_gauge_weight(accounts, rpc, gauge_controller, three_gauges):
    gauge_controller.add_gauge(three_gauges[0], 0, 10**18, {'from': accounts[0]})
...
def test_multiple(accounts, rpc, gauge_controller, three_gauges):
